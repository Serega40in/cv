...
;(function($, window, document, undefined) {
	...
	Lazy.prototype.load = function(position) {
		...
		$elements.each($.proxy(function(index, element) {
			...
			if ($element.is('img')) {
				$element.one('https://demo.kautilyalawcollege.com/paul-gatter/assets/plugins/owlcarousel/load.owl.lazy', $.proxy(function() {
...
;(function($, window, document, undefined) {
	...
	var AutoHeight = function(carousel) {
		...
		this._handlers = {
			...
			'https://demo.kautilyalawcollege.com/paul-gatter/assets/plugins/owlcarousel/loaded.owl.lazy': $.proxy(function(e) {
